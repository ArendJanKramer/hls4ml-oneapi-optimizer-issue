...
class MyprojectClassFloat_ba077729;
...
void myproject_float(
    ...
    q.single_task<MyprojectClassFloat_ba077729>(Myproject{});
    nnet::convert_data_back<Layer13OutPipe, float, N_LAYER_11>(q, layer13_out);

    q.wait();
}

class MyprojectClassDouble_ba077729;
...
void myproject_double(
    ...
    q.single_task<MyprojectClassDouble_ba077729>(Myproject{});
    nnet::convert_data_back<Layer13OutPipe, double, N_LAYER_11>(q, layer13_out);
